...
@section('content')
    ...
    <div style="padding-left: 50px;" >
        <div class="col-xl-12">
            <div class="card">
                <h5 class="card-header">Custom short url</h5>
                <div class="card-body">
                    <form method="post" action="{{route('customurl.create')}}">
                        @csrf
                        <div class="input-group mb-3">
                            <input type="text" name="oldurl" placeholder="oldurl" class="form-control">
                            <input style="margin-left: 20px;"  placeholder="customname" type="text" name="newkey" class="form-control">
