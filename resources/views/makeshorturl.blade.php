...
<section id="about">
    ...
    <div class="row about-intro">
        ...
        <div class="col-four">
            <h1 class="intro-header" >Create short url at one click</h1>
        </div>
        <div class="col-six">
            ...
            <form method="post" action="{{route('url.short')}}">
                ...
                <input  type="url" placeholder="your long url" class="form-control" name="url" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
                <input type="submit" class="btn btn-lg"  value="make it shorten" />
            ...
            @isset($shorturl)
                <p>Your short url:</p>
                <p style="color:maroon;font-size:25px;" id="shorturl"> {{ $shorturl }} </p>
